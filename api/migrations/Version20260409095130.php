 ...
 */
final class Version20260409095130 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE cashbox_transfer ADD exchange_rate NUMERIC(15, 6) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE cashbox_transfer ADD target_amount NUMERIC(15, 2) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE cashbox_transfer ADD target_currency VARCHAR(3) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE cashbox_transfer DROP exchange_rate
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE cashbox_transfer DROP target_amount
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE cashbox_transfer DROP target_currency
        SQL);
    }
}
