...
-- Výchozí role
-- sql
INSERT INTO staff_role (name, description, required_per_guests, guests_ratio, created_at) VALUES
('Koordinátor', 'Koordinátor akce', 1, 0, now()),
('Číšník', 'Obsluha hostů', 1, 10, now()),
('Kuchař', 'Příprava jídla', 1, 20, now()),
('Tanečník', 'Folklórní tanec', 4, 0, now()),
('Kapela', 'Hudební doprovod', 3, 0, now()),
('Moderátor', 'Moderování programu', 1, 0, now()),
('Pomocná síla', 'Pomocné práce', 1, 15, now()),
('Fotograf', 'Fotografování akce', 1, 0, now());
